...
SECRET_KEY = 'django-insecure-zuf!9a3av%t3-qke@@&!qcl8#*!=!m4r7vt*^y5-#!^%!)h2=t'
...
STATICFILES_DIR = [os.path.join(BASE_DIR,'static')]    #STATICFILES_DIR = []
...
MEDIA_ROOT = os.path.join(BASE_DIR,
                          'media')  # формируем путь к каталогу с фотографиями;BASE_DIR-корень каталога и папка которую ищем
MEDIA_URL = '/media/'
